    ...
    function drawChart() {
      ...
      dayRects.enter().append('rect')
        ...
        .attr('x', function (d, i) {
          ...
          return result * (SQUARE_LENGTH + SQUARE_PADDING) + 16;
        })
        .attr('y', function (d, i) {
      ...
      if (chart.legendEnabled()) {
        ...
        legendGroup.selectAll('.calendar-heatmap-legend')
          ...
          .append('rect')
            ...
            .attr('y', height - 16 + SQUARE_PADDING)
            .attr('fill', function (d) { return d; });

        legendGroup.append('text')
          .attr('class', 'calendar-heatmap-legend-text calendar-heatmap-legend-text-less')
          .attr('x', width - legendWidth - 13)
          .attr('y', height -16 + SQUARE_LENGTH)
          .text(locale.Less);
      ...
      var monthLabels = svg.selectAll('.month')
          ...
          .attr('x', function (d, i) {
            ...
            if (matchIndex == 0) {  // hide first month off screen (firefox bug)
              return -4*(SQUARE_LENGTH + SQUARE_PADDING);
            }
            return 30+Math.floor(matchIndex / 7) * (SQUARE_LENGTH + SQUARE_PADDING);
          })
      ...
      locale.days.forEach(function (day, index) {
        ...
        if (index % 2) {
          svg.append('text')
            ...
            .attr('transform', 'translate(6,' + (SQUARE_LENGTH + SQUARE_PADDING) * (index + 1) + ')')
